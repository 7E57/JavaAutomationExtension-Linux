...
async def info(ctx):
    ...
    embed.add_field(name=f"{prefix}restart", value="Restart Mewt", inline=False)
    embed.add_field(name=f"{prefix}autorestart (minutes)", value="Turn on Autorestart and restart Mewt every X minutes **Example: {prefix}restart 20**", inline=False)
